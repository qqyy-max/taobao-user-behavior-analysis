-- ============================================================
-- 02_funnel_retention.sql — 转化漏斗 & 用户留存层
-- ============================================================
-- 职责：行为漏斗、用户转化率、Cohort 留存矩阵
-- 输出表：
--   funnel_summary            — Power BI 漏斗图
--   user_conversion_summary   — 用户行为渗透率一览
--   cohort_retention_detail   — Power BI 留存热力图
--   cohort_retention_summary  — 留存汇总曲线
-- 依赖：00_init.sql（提供 clean 视图 + user_base_metrics 中间表）
-- ============================================================


-- ============================================================
-- 1. funnel_summary — 转化漏斗
-- ============================================================
-- 以 PV 用户数为基准 100%，计算各阶段 UV 渗透率
...
-- ============================================================
-- 3. cohort_retention_detail — 留存明细（Power BI 热力图）
-- ============================================================
...
-- ============================================================
-- 4. cohort_retention_summary — 留存汇总（留存曲线）
-- ============================================================
